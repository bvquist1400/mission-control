-- Ensure template-instantiated projects persist kickoff as target_date
-- and generated task due dates remain stable across local timezone rendering.
...
BEGIN
  ...
  LOOP
    ...
    v_resolved_due_at := CASE
      ...
      ELSE ((p_kickoff_date + task_row.relative_due_days)::text || 'T23:59:59.999Z')::timestamptz
    END;
