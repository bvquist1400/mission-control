...
function createMcpServer(): McpServer {
  ...
  mcp.tool(
    ...
    'Create a new task. Only title is required.',
    {
      ...
      blocked_reason: z.enum(['prerequisite', 'need_info', 'decision', 'approval', 'external', 'other']).optional().describe('Structured category for why the task is blocked'),
  ...
  mcp.tool(
    ...
    'Update an existing task. Provide task_id and any fields to change.',
    {
      ...
      blocked_reason: z.enum(['prerequisite', 'need_info', 'decision', 'approval', 'external', 'other']).nullable().optional().describe('Structured category for why the task is blocked'),
